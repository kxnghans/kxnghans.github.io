...
- **Recessed Wells**:
  - *Search Bar*: `bevel-light-inset bevel-dark-inset bg-gray-200 dark:bg-dark-well` (`#141416`).
  - *Form Inputs*: `colors.well` (`#242529` in dark mode) paired with dual-vector inset shadows (`inset 6px 6px 12px #1a1b1e, inset -6px -6px 12px #2e2f34`).

...
export const skillsData: SkillCategory[] = [
  ...
  },
  {
    ...
    details: [
      { name: "Agile & Scrum Master (SAFe, Kanban)", priority: 1 },
      { name: "JIRA & Confluence", priority: 1 },
      { name: "Concept of Operations (CONOPS)", priority: 1 },
      { name: "Governance (ARB, SIA, CARB)", priority: 1 },
      { name: "MBSE (Cameo, IBM DOORS)", priority: 2 },
      { name: "Stakeholder Mediation & Conflict Resolution", priority: 2 },

  ...
  // Graduate Degree: UC Berkeley Master of Science in Data Science
  {
    ...
    details: {
      ...
      highlights: [
        ...
        { label: "Core Focus", value: "MLOps & Deep Learning" },
      ],
      details: [
  ...
  // Undergraduate Degree: UCCS Bachelor of Science in Electrical Engineering
  {
    ...
    details: {
      ...
      highlights: [
        ...
        { label: "Academic Honors", value: "Cum Laude (7x President's & Dean's Lists)" },
        { label: "Senior Capstone", value: "AR-VR Flight Simulator" },
        { label: "Dual Commitment", value: "USAF Reserve & Developer" },
      ],
      details: [
